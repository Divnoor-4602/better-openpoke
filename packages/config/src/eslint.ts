...
/**
 * @param {{ rootUrl: string | URL }} options
 */
export function createEslintConfig({ rootUrl }) {
  const appRootUrl = rootUrl instanceof URL ? rootUrl : new URL(rootUrl);
  const featuresUrl = new URL("./src/features", appRootUrl);
