// Generates server/generated/tool_schemas.json from the catalog's Zod
...
// time — see server/agents/tool_schemas.py.
...
const target = resolve(here, '../../../server/generated/tool_schemas.json')
