...
const GoogleIcon = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      <defs>
        <linearGradient id="google-icon-a">
          <stop offset="0" stopColor="#0fbc5c" />
          <stop offset="1" stopColor="#0cba65" />
        </linearGradient>
        <linearGradient id="google-icon-g">
        ...
        <linearGradient id="google-icon-h">
        ...
        <linearGradient id="google-icon-f">
        ...
        <linearGradient id="google-icon-b">
        ...
        <linearGradient id="google-icon-d">
          <stop offset=".4084578" stopColor="#fb4e5a" />
          <stop offset="1" stopColor="#ff4540" />
        </linearGradient>
        <linearGradient id="google-icon-c">
        ...
        <linearGradient id="google-icon-e">
        ...
        <clipPath clipPathUnits="userSpaceOnUse" id="google-icon-i">
          <path
      ...
      <g transform="matrix(0.957922,0,0,0.985255,-90.17436,-78.85577)">
        <g clipPath="url(#google-icon-i)">
          <path
            ...
            fill="url(#google-icon-j)"
            filter="url(#google-icon-k)"
          />
          <path
          ...
          <path
            ...
            fill="url(#google-icon-p)"
            filter="url(#google-icon-q)"
          />
          <path
