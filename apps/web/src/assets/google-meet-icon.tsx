...
const GoogleMeetIcon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg fill="none" viewBox="0 0 256 211" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path d="m144.822 105.322 24.957 28.527 33.562 21.445 5.838-49.792-5.838-48.669-34.205 18.839z" fill="#00832D" />
      <path d="M0 150.66v42.43c0 9.688 7.864 17.554 17.554 17.554h42.43l8.786-32.059-8.786-27.925-29.11-8.786z" fill="#0066DA" />
      <path d="M59.984 0 0 59.984l30.876 8.765 29.108-8.765 8.626-27.545z" fill="#E94235" />
